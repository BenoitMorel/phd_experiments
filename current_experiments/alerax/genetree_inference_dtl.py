...
if (do_plot):
  ...
  metric_names = ["average_rrf", "runtimes"]
  #methods_tuples.append(("astralpro2_raxml-ng","APro2-raxml"))
  methods_tuples.append(("alegenerax-tcnone-fam-orunif_mrbayes-r1-c2-g100K-f100-braxml","AleRax"))
  methods_tuples.append(("ale-dtl-mrbayes-r1-c2-g100K-f100-braxml", "ALE"))
  metric_labels["average_rrf"] = "RFD to true gene trees"
  metric_labels["runtimes"] = "Runtimes (seconds)"
  param_labels["sites"] = "Sites"
  param_labels["dup_rate"] = "DTL rates"
  param_labels["bl"] = "Branch length scaler"
  param_labels["species"] = "Number of species"
...
def plot_varying_experiment():
  for entry in varying_params:
    ...
    for metric in metric_names:
      ...
      plot_simulations.plot_varying_params(datasets, param, metric, methods_tuples, subst_model, output,  logscale = logscale, xlabel = param_labels[param], ylabel = metric_labels[metric])
