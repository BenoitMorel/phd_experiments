...
#varying_params.append(("bl", ["bl1000.0"]))
varying_params.append(("dup_rate", ["d5.0_l5.0_t5.0"]))
varying_params.append(("dt_ratio", ["d5.0_l5.0"]))
#varying_params.append(("dt_ratio", ["d0.0_l0.0", "d0.5_l0.5", "d2.0_l2.0"]))
#varying_params.append(("gene_conversion_rate", ["gc0.5", "gc1.0", "gc2.5", "gc10.0"]))
#varying_params.append(("bl", ["bl0.01", "bl0.1", "bl10.0", "bl25.0", "bl50.0", "bl100.0"]))
