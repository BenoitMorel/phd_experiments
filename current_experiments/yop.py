...
gene_trees = ["raxml-ng"]
launch_mode = "normal"
replicates = range(7000, 7001)
varying_params = []
#varying_params += ["none"]
#varying_params += ["f1000"]
#varying_params += ["s15", "s50"]
varying_params += ["sites600"]
varying_params += ["pop1000000000"]
#varying_params += ["f50", "f200"]
#varying_params += ["d0.5_l0.5", "d3.0_l3.0"]
#varying_params += ["t0.0", "t3.0"]

tag = "varyplop"
fixed_point = "ssim_varyplop_s25_f100_sites100_GTR_bl1.0_d1.0_l1.0_t0.0_p0.0_pop10_mu1.0_theta0.0_seed20"
