...
joint_search_gprof_exec = os.path.join(joint_search_root, "gprof_build", "bin", "generax")
joint_search_scalasca_exec = os.path.join(joint_search_root, "scalasca_build", "bin", "generax")
