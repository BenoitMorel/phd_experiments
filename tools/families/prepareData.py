...
if __name__ == '__main__':
  ...
  #Alignment folder
  listAlns=list()
  SEQDIR = input("Absolute PATH to the folder containing all the alignment files?\t")
  ...
  #link file folder
  listLinks = list()
  LINKDIR = input("Absolute PATH to the folder containing all the link files?\t")
  ...
  #Option file folder
  OPTDIR = input("Absolute PATH to the folder that will contain all the option files?\t")
  ...
  #Result file folder
  RESDIR = input("Absolute PATH to the folder that will contain all the result files?\t")
  ...
  #Species tree
  TREEFILEGIVEN = input("Do you want to provide a starting species tree (Newick)?\t").upper()
  ...
  if ( "YES".startswith(TREEFILEGIVEN) ):
    TREEFILE = input("Absolute PATH to the starting species tree file (Newick)?\t")
    ...
    STARTINGTREE = input("What kind of species tree? RANDOM or MRP?\t").upper()
  ...
  DLPARAM = input("Do you want to optimize the duplication and loss parameters?\t").upper()
  ...
  if ("YES".startswith(DLPARAM) ):
      DLOPT = input("How do you want to optimize the duplication and loss parameters? Branchwise or average ?\t").upper()
  ...
  EQUGENOMES = input("Do you want to assume that all genomes, if they had no missing data, would have the same number of genes?\t").upper()
  ...
  TOPOGENE = input("Do you want to optimize the gene tree topologies?\t").upper()
  ...
  #Time limit
  TIMELIMIT = input("What time limit do you want to set, in hours (minimum 2h)?\t")
  ...
  for aln in listAlns:
    ...
    if (dictLinks.__contains__(radical)):
      ...
      try:
        ...
        print ("Unknown file: " + str(dictLinks[radical]))
        sys.exit()
      for l in fin:
        num=1
        sp = l.split(":")[0]
