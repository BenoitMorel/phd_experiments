...
def aux(dataset, model):
  ...
  plot_histogram.plot_grouped_histogram(yvalues, cat_name = "Category", class_name = "Methods", values_name = "Absolulte log-likelihoods", start_at_min_y = True, x_order = x_order, output = output + ".svg")
